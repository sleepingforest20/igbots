...
export declare class DirectThreadEntity extends Entity {
    threadId: string;
    userIds: string[];
    deleteItem(itemId: string | number): Promise<import("../responses").StatusResponse>;
    broadcastText(text: string): Promise<import("../responses").DirectThreadRepositoryBroadcastResponsePayload>;
    broadcastProfile(id: number | string): Promise<import("../responses").DirectThreadRepositoryBroadcastResponsePayload>;
    ...
    broadcastVideo(options: DirectThreadBroadcastVideoOptions): Promise<import("../responses").DirectThreadRepositoryBroadcastResponsePayload>;
