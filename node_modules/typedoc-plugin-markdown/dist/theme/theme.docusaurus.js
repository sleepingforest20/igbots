...
class DocusaurusTheme extends theme_1.MarkdownTheme {
    ...
    writeSideBar(outputDirectory, docusarusRoot) {
        ...
        const packageName = plugin_1.MarkdownPlugin.project.packageInfo.name;
        ...
        const update = Object.assign({}, jsonContent, { [packageName]: navObject });
        try {
    ...
    getNavObject(docsRoot) {
        const projectUrls = [docsRoot + this.indexName.replace('.md', '')];
        if (plugin_1.MarkdownPlugin.project.url === this.globalsName) {
